========================================================================
		ActiveX Control DLL : RISKBOARDVC
========================================================================

ControlWizard has created this project for your RISKBOARDVC ActiveX Control
...
that make up your RISKBOARDVC ActiveX Control DLL.
...
RiskBoardVCCtl.h
	This file contains the declaration of the CRiskBoardVCCtrl C++ class.

RiskBoardVCCtl.cpp
	This file contains the implementation of the CRiskBoardVCCtrl C++ class.

RiskBoardVCPpg.h
	This file contains the declaration of the CRiskBoardVCPropPage C++ class.

RiskBoardVCPpg.cpp
	This file contains the implementation of the CRiskBoardVCPropPage C++ class.

RiskBoardVCCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CRiskBoardVCCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file RiskBoardVC.rc.
