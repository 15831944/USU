...
void CManualControl::OnClose() 
{
	...
	//KillTimer(IDC_WATERB);
	//KillTimer(IDC_FANS);
	//KillTimer(IDC_LIGHTS);
	//KillTimer(IDC_WATERF);
	//KillTimer(IDC_WATERB);
	//KillTimer(IDC_APUMP);
...
BOOL CManualControl::PreTranslateMessage(MSG* pMsg) 
{
...
{
	SetWindowText(Strings.get(IDS_I0));
...
BOOL CManualControl::OnInitDialog() 
{
	...
	SetItemFont(IDC_CHAMBER_A,this);
	SetItemFont(IDC_CHAMBER_B,this);
	SetItemFont(IDC_FANS,this);
	SetItemFont(IDC_LIGHTS,this);
	SetItemFont(IDC_WATERF,this);
	SetItemFont(IDC_WATERB,this);
	SetItemFont(IDC_APUMP,this);
