...
BOOL Verify::OnInitDialog() 
{
	...
	SetItemFont(IDC_UNITS,this);
//	SetItemFont(IDC_CELSIUS,this);
//	SetItemFont(IDC_PERCENT,this);
	SetItemFont(IDC_MERC1,this);
	SetItemFont(IDC_MERC2,this);
	SetItemFont(IDC_MERC3,this);
...
void Verify::SetStrings()
{
	...
	GetDlgItem(IDC_UNITS)->SetWindowText(Strings.get(IDS_T9));
	GetDlgItem(IDC_MERC1)->SetWindowText(Strings.get(IDS_T10));
	GetDlgItem(IDC_MERC2)->SetWindowText(Strings.get(IDS_T10));
	GetDlgItem(IDC_MERC3)->SetWindowText(Strings.get(IDS_T10));
	GetDlgItem(IDC_REFRESH)->SetWindowText(Strings.get(IDS_T11));
