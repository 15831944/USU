...
void CCamerasPage::SetStrings(BOOL updateData)
{
	...
	GetDlgItem(IDC_TEXT10)->SetWindowText(Strings.get(IDS_AA10));
	GetDlgItem(IDC_CHANGE_FREQ)->SetWindowText(Strings.get(IDS_AA30));
	UpdateData(FALSE);
...
BOOL CCamerasPage::OnInitDialog() 
{
	...
	GetDlgItem(IDC_CHANGE_FREQ)->SetFont(&RussianArial);
