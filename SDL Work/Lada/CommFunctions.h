...
{
public:
	static HANDLE hCommLog;
	static void WriteToCommLog(char t, unsigned char *data, int length);
	static void WriteToCommLog(char * message);
	void CloseCommLog();
	void OpenCommLog(char * folder);
	CCommFunctions();
