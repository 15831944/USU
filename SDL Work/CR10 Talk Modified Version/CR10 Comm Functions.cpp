...
BOOL CommFunctions::CreateCR10TalkInfo()
{
...
BOOL CommFunctions::OpenConnection()
{
...
BOOL CommFunctions::SetupConnection()
{
	BOOL       fRetVal ;
	DCB        dcb ;
...
//DWORD FAR PASCAL CommFunctions::CommWatchProc( LPSTR lpdata )
...
BOOL CommFunctions::WriteCommBlock( const LPSTR lpData , DWORD dwBytesToWrite)
{
	BOOL        fWriteStat ;
...
BOOL CommFunctions::CloseConnection()
{
...
BOOL CommFunctions::DestroyCR10TalkInfo()
{
...
DWORD __stdcall CommFunctions::CommWatchProc(void *lpdata)
{
	...
	if (os.hEvent == NULL)
	{
		MessageBox( NULL, "Failed to create event for thread!", "CR10 Talk Error!",
...
int CommFunctions::ReadCommBlock( CR10TalkInfo *TalkInfo, LPSTR lpszBlock, int nMaxLength )
{
	BOOL       fReadStat ;
	DWORD      dwErrorFlags;
	DWORD	   dwError;
	...
	if (dwLength > 0)
	{
		...
		switch (dwLength) {
		case 1:
		  wsprintf(szError,"\nRead: %hu, 1 byte read... %hu '%hc'", 
		  readNum, lpszBlock[0], lpszBlock[0]);
		  break;
	  case 2:
		  wsprintf(szError,"\nRead: %hu, 2 bytes read... %hu '%hc' %hu '%hc'", 
		  readNum, lpszBlock[0], lpszBlock[0],
		  lpszBlock[1], lpszBlock[1]);
		  break;
	  case 3:
		  wsprintf(szError,"\nRead: %hu, 3 bytes read... %hu '%hc' %hu '%hc' %hu '%hc'", 
		  readNum, lpszBlock[0], lpszBlock[0],
		  lpszBlock[1], lpszBlock[1],
		  lpszBlock[2], lpszBlock[2]);
		  break;
	  case 4:
		  wsprintf(szError,"\nRead: %hu, 4 bytes read... %hu '%hc' hu' %hc' %hu '%hc' %hu '%hc'", 
		  readNum, lpszBlock[0], lpszBlock[0],
		  lpszBlock[1], lpszBlock[1],
		  lpszBlock[2], lpszBlock[2],
		  lpszBlock[3], lpszBlock[3]);
		  break;
	  case 5:
		  wsprintf(szError,"\nRead: hu, 5 bytes read... %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc'", 
		  readNum, lpszBlock[0], lpszBlock[0],
		  lpszBlock[1], lpszBlock[1],
		  lpszBlock[2], lpszBlock[2],
		  lpszBlock[3], lpszBlock[3],
		  lpszBlock[4], lpszBlock[4]);
		  break;
	  case 6:
		  wsprintf(szError,"\nRead: hu, 6 bytes read... %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc'", 
		  readNum, lpszBlock[0], lpszBlock[0],
		  lpszBlock[1], lpszBlock[1],
		  lpszBlock[2], lpszBlock[2],
		  lpszBlock[3], lpszBlock[3],
		  lpszBlock[4], lpszBlock[4],
		  lpszBlock[5], lpszBlock[5]);
		  break;
	  case 7:
		  wsprintf(szError,"\nRead: %hu, 7 bytes read... %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc'", 
		  readNum, lpszBlock[0], lpszBlock[0],
		  lpszBlock[1], lpszBlock[1],
		  lpszBlock[2], lpszBlock[2],
		  lpszBlock[3], lpszBlock[3],
		  lpszBlock[4], lpszBlock[4],
		  lpszBlock[5], lpszBlock[5],
		  lpszBlock[6], lpszBlock[6]);
		  break;
	  default:
		  wsprintf(szError,"\nRead: %hu, %hu bytes read... %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc' %hu '%hc'", 
		  readNum, dwLength, lpszBlock[0], lpszBlock[0],
		  lpszBlock[1], lpszBlock[1],
		  lpszBlock[2], lpszBlock[2],
		  lpszBlock[3], lpszBlock[3],
		  lpszBlock[4], lpszBlock[4],
