...
void CFinalStoragePage::OnOK() 
{
	...
	if (IsModified)
	{
			...
			// final storage collection frequency has changed
		{
			...
			// this line of code should cause the next final storage collection frequency to be 
			// set to an offset of the frequency from the current time
			pDoc->m_FSCollectionParam.m_NextCollectionTime = 0;
