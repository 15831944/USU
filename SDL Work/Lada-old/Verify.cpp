...
//	temp=ValueToString(m_cv1,2);
	print->data[36][1]=ValueToString(m_cv1,2);
	print->data[37][1]=ValueToString(m_cv2,2);
	print->data[38][1]=ValueToString(m_cv3,2);
	print->data[39][1]=ValueToString(m_cv4,2);
	print->data[40][1]=ValueToString(m_cv5,2);
	print->data[36][2]=ValueToString(m_uv1,2);
	print->data[37][2]=ValueToString(m_uv2,2);
	print->data[38][2]=ValueToString(m_uv3,2);
	print->data[39][2]=ValueToString(m_uv4,2);
	print->data[40][2]=ValueToString(m_uv5,2);
	CDialog::OnOK();
}
...
{
	double temp;
	pDoc->GetInputLocations(&loc,1,&temp);
	return temp;
