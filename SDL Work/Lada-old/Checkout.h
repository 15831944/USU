...
public:
	...
	CString data[44][3];		// data stores the data that is gathered during checkout with the proper names
	CString units[44];			// units stores the units used in the data gathered
