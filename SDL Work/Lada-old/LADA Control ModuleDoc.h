...
public:
	...
	BOOL GetInputLocations(int *ptrFirstLocation, int nLocations, double *ptrReturnData, BOOL useDocIndex = FALSE);
	...
	BOOL SetControlParameters(int whichChamber, double MoistLevel, BOOL In24Hour, int LightOn, int LightOff, int SMPFreq );	
	BOOL StopComm();
	BOOL UnloadCameras();
	BOOL WaitForNewData();
