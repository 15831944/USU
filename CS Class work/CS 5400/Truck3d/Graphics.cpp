...
void Vector3d::UpdateVector(double x1, double y1, double z1, double w1)
...
class WindowClass
{
    ...
    public:
		...
		void ProjectPoints(double yRot, double xOff, double yOff, 
						   double zOff, int P[][2], int nList, 
						   double points[][3], int nPoints, Vector3d V, 
						   Vector3d C, double viewDist, COLORREF color);
...
(double yRot, double xOff, double yOff, 
 double zOff, int P[][2], int nList, 
 double points[][3], int nPoints, Vector3d V, 
 Vector3d C, double viewDist, COLORREF color)
{
	...
	static double dx, dy, dz, tx, ty, tz, x, y, z;
	static double l, l2, sin1, cos1, sin2, cos2;
	static double d = 4;
	static double zoomFactor = 600;
...
/*					
void WindowClass::ProjectPoints(double yRot, double xOff, double yOff, double zOff, int P[][2], int nList, double points[][3], int nPoints, Vector3d V, Vector3d C, double viewDist, COLORREF color)
{
