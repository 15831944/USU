...
A123. Repeat A111 but with templates so your linked list can be a linked list of any type. 
Have your driver program test it with 10 random integers and 10 random complex numbers. 
*/
#include <iostream.h>
#include <assert.h>
#include <stdlib.h>
...
void main()
{
   ...
   List< int > intList;
   testList( intList, "int", 10 ); // test intList

   List< double > doubleList;
   testList( doubleList, "double", 10 ); // test doubleList

   List< complex > complexList;
   testList( complexList, "complex numbers", 10 ); // test complex
