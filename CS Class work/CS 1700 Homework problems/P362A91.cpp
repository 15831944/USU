...
//                          
//           
// I found out that Ackermann(3, 4) = 2^2^65536 - 3 that's one big number,
// and the other numbers are even bigger!
// They can even be expressed using a special mathematical notation for "big
// numbers.  2 ^^ 4 means 2 ^ 2 ^ 2 ^ 2
/*		  1.A(1, n) = 2 + (n + 3) - 3 
        2.A(2, n) = 2 (n + 3) - 3 
        3.A(3, n) = 2 ^ (n + 3) - 3 
        4.A(4, n) = 2 ^^ (n + 3) - 3 
