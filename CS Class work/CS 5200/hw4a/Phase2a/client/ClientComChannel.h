...
public:
	...
	BOOL receiveId(long& id, DString &server_ip, UINT &server_port, unsigned long max_time=DEFAULT_TIMEOUT);
	BOOL receiveCount(short& count, DString &server_ip, UINT &server_port, unsigned long max_time=DEFAULT_TIMEOUT);
