...
Object = "{7926AF74-B815-11D5-B022-0002E3059EB4}#1.0#0"; "DiagramControl.ocx"
...
Private Sub RemoveComponentButton_Click()
    ...
    For i = SelectedComponentList.ListItems.Count To 1 Step -1
        If SelectedComponentList.ListItems.Item(i).Selected = True Then
            RemoveSelection SelectedComponentList.ListItems(i).tag, True
        End If
    Next i
End Sub
...
Private Sub ShowEditMenu()
    ...
    Else
        ...
        ElseIf (NodeData(ActiveListIndex).nodetype = componentNode) Then
            ...
            menuItems(7).Enabled = DoesParentHaveDiagram(ActiveListIndex)
