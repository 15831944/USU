========================================================================
		ActiveX Control DLL : ACTIVED3D
========================================================================

ControlWizard has created this project for your ACTIVED3D ActiveX Control
...
that make up your ACTIVED3D ActiveX Control DLL.
...
ActiveD3DCtl.h
	This file contains the declaration of the CActiveD3DCtrl C++ class.

ActiveD3DCtl.cpp
	This file contains the implementation of the CActiveD3DCtrl C++ class.

ActiveD3DPpg.h
	This file contains the declaration of the CActiveD3DPropPage C++ class.

ActiveD3DPpg.cpp
	This file contains the implementation of the CActiveD3DPropPage C++ class.

ActiveD3DCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CActiveD3DCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file activeD3D.rc.
